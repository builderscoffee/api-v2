...
import eu.builderscoffee.api.common.data.tables.*;
...
public class DataManager {
    ...
    @Getter private static EntityDataStore<ServerActivity> serverActivityStore;
    ...
    public static void init(HikariConfig config){
        ...
        serverActivityStore = new EntityDataStore<>(hikari, Models.DEFAULT);
